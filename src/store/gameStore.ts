...
interface Character {
  ...
  armorSlotId?: string | null;
  helmetSlotId?: string | null;
  glovesSlotId?: string | null;
  shoesSlotId?: string | null;
  ringSlotId?: string | null;
  necklaceSlotId?: string | null;
  beltSlotId?: string | null;
  earringSlotId?: string | null;
  companion?: any;
...
interface GameState {
  ...
  setHasUnreadServerMessages: (hasUnread: boolean) => void;
...
export const useGameStore = create<GameState>((set) => ({
  ...
  setHasUnreadServerMessages: (hasUnread) => set({ hasUnreadServerMessages: hasUnread }),
