...
interface GameState {
  ...
  // UI State
  activeTab: 'village' | 'adventure' | 'guild' | 'shop' | 'leaderboard' | 'friends' | 'admin' | 'settings';
  isLoading: boolean;
  ...
  setActiveTab: (tab: 'village' | 'adventure' | 'guild' | 'shop' | 'leaderboard' | 'friends' | 'admin' | 'settings') => void;
