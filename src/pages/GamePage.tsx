...
import FloatingText, { useFloatingText } from "@/components/effects/FloatingText";

export default function GamePage() {
  const { effects, addEffect, removeEffect } = useFloatingText();
  ...
  const setupSocketListeners = () => {
    onIdleComplete((data) => {
      ...
      // Visual effects
      addEffect(`+${data.goldEarned} Gold`, "#fbbf24");
      setTimeout(() => addEffect(`+${data.expEarned} XP`, "#60a5fa"), 300);
